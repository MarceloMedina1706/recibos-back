...
{
    public static class NumeroTexto
    {
        public static string NumeroALetras(this decimal numberAsString)
        {
            ...
            if (decimales > 0)
            {
                ...
                dec = NumeroALetras(Convert.ToDouble(entero)) + " CON " + NumeroALetras(Convert.ToDouble(decimales));
            }
            else
            {

                dec = NumeroALetras(Convert.ToDouble(entero));
            }
            var res = dec;
            return res;
        }
